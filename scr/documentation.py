...
def documentations():
    """
    This function displays the documentation for the project.

    It displays the sidebar with the title, subtitle, description and
    a button to access the documentation page.

    The documentation page contains information on how to get started
    with the Hugging Face API and Streamlit settings.
    ...
    with st.sidebar.expander("Documentation", expanded=True):
        st.write(
            """Welcome to the documentation page for our project.
        ...
        st.write(
            """To use the Hugging Face API, you need to obtain an
        ...
        st.write(
            """Now you can use the Hugging Face API in your
